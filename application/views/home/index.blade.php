...
<div class="wrapper">
    ...
    <div role="main" class="main">
        <div class="home">
            ...
            <div class="content">
                ...
                <table class="bpm-form">
                    <tr>
                        <th><?= Form::label('soort', 'Soort auto'); ?></th>
                    ...
                    <tr>
                        ...
                        <td><?= Form::text('co2_uitstoot', Input::get('co2_uitstoot')); ?>
                            <small>gram / km</small>
                        </td>
                    </tr>
                    <tr>
                        <th><?= Form::label('netto_catalogusprijs_eerste_ingebruikname', 'Netto-catalogusprijs bij eerste ingebruikname'); ?></th>
                        <td><?= Form::text('netto_catalogusprijs_eerste_ingebruikname', Input::get('netto_catalogusprijs_eerste_ingebruikname')); ?>
                            <small>EUR</small>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td><?= Form::text('consumentenprijs', Input::get('consumentenprijs')); ?>
                            <small>EUR</small>
                        </td>
                    </tr>
                    <tr>
                        <th>
                            ...
                            <small>Volgens koerslijst of tegentaxatie</small>
                        </th>
                        <td><?= Form::text('inkoopwaarde', Input::get('inkoopwaarde')); ?>
                            <small>EUR</small>
                        </td>
                    </tr>
                </table>
    ...
    <footer>
        Auto invoeren? Bereken hier snel de bpm! - Vragen of suggesties? <a href="mailto:info@snelbpmberekenen.nl">info@snelbpmberekenen.nl</a>
        <br>
        <small>Hoewel de berekening geheel volgens de berekening van de Belastingdienst wordt gedaan, kunnen hier geen
